...
const osms = require("../third_party/osm/lib.js");
...
interface OsmStaticMapsOptions {
  ...
  /**
   * enable lossless compression with [optipng]
   * (https://github.com/imagemin/imagemin-optipng) / [jpegtran](https://github.com/imagemin/imagemin-jpegtran)
   * @defaultValue `false`
   */
  imagemin?: boolean;
  ...
  /**
   * enable render a scale ruler
   * (boolean or [a json options object](https://leafletjs.com/reference-1.6.0.html#control-scale-option))
   * @defaultValue `false`
   */
...
export const osmsC = function <T extends OsmStaticMapsOptions>(
  options?: T
