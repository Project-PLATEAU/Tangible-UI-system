...
// このファイルは上記のlib.jsを改変したものになります。
// puppeteerのバージョンアップに伴い、初期化のオプションに[headless: 'new']が必要になったため。
// https://ths-net.co.jp/shopify_blog/puppeteer/
// 合わせてtemplate.htmlも上記githubより利用
// Written by Makoto Wakayama. 2023/8 InfoLounge Coorporation.
  ...
  async launch() {
    return puppeteer.launch({
      args: [...chrome.args, "--no-sandbox", "--disable-setuid-sandbox",
        "--disable-gpu", "--disable-dev-shm-usage", "--no-first-run", "--no-zygote", "--single-process" // ILC
      ],
      // defaultViewport: chrome.defaultViewport, ILC
      // executablePath: await chrome.executablePath, ILC
      // change params true -> 'new'
      headless: 'new',
